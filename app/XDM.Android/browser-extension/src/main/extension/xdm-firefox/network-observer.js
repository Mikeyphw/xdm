(() => {
  ...
  async function dispatchTab(tabId) {
    ...
    const payload = Object.assign({}, candidate, {
      ...
      thumbnailProvenance: candidate.thumbnailProvenance || "Unknown",
      candidateCount,
  ...
  function processPageObservation(message, sender) {
    ...
    if (responseUrl && evidence) {
      added = mergeCandidate(tabId, Object.assign({}, evidence, {
        ...
        thumbnailProvenance: observation.thumbnailProvenance || evidence.thumbnailProvenance || "Unknown",
  ...
  function processFramePlayback(message, sender) {
    ...
    const added = mergeCandidate(tabId, Object.assign({}, evidence, {
      ...
      thumbnailProvenance: value.thumbnailProvenance || evidence.thumbnailProvenance || "Unknown",
      pageUrl: sender && sender.tab ? sender.tab.url || "" : evidence.pageUrl || "",
      title: sender && sender.tab ? sender.tab.title || "" : evidence.title || "",
      quality: "strong",
      autoOffer: true,
