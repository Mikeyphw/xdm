...
object FinalAndroidDownloaderRcSealPlanner {
    fun evaluate(
        ...
        browserTopologyTruthful: Boolean,
        ...
        val checks = listOf(
            ...
            check(
                title = "Browser and media-capture topology truthful",
                ready = browserTopologyTruthful,
                readyDetail = "The lightweight Live Locator WebView and external browser handoff are represented truthfully without claiming XDM as a general-purpose browser.",
                blockedDetail = "Release truth must represent the shipped Live Locator WebView; historical browser-free assertions cannot be current blockers.",
                owner = "MediaParity01RuntimeTruthContractTest",
            ),
            check(
