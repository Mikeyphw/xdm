...
object FinalReleaseGateExplainer {
    ...
    private fun fixActionFor(id: String): String = when (id) {
        ...
        "database.schema" -> "Keep reviewed schema 23 and its complete migration chain, or add a reviewed migration and update the release contract."
            ...
            if (schemaVersion != 23) {
                add(
                    FinalReleaseGateCheck(
                        ...
                        detail = "The public release gate expects reviewed Room schema v23 after the reviewed migration chain through MC04 manifest hardening.",
                    ),
                )
            }
