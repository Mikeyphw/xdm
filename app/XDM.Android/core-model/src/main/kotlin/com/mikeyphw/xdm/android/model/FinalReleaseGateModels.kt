...
object FinalReleaseGateExplainer {
    ...
    private fun fixActionFor(id: String): String = when (id) {
        ...
        "database.schema" -> "Keep reviewed schema 24 and its complete migration chain, or add a reviewed migration and update the release contract."
            ...
            if (schemaVersion != 24) {
                add(
                    FinalReleaseGateCheck(
                        ...
                        detail = "The public release gate expects reviewed Room schema v24 after the reviewed migration chain through MC04 manifest hardening.",
                    ),
                )
            }
