...
Phase 16 prepares XDM Android for release packaging and update testing without changing the app's route topography or Room schema.
...
- Keep the base package identity stable as `com.mikeyphw.xdm.android` while retaining debug suffixes for side-by-side testing.
...
- Retain the aria2 runtime payload gate for release packaging.
