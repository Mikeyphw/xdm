...
- Scan external page context, resolver handoff, queue specs, Room metadata, sidecars, logs, notifications, temp files, and Termux command previews.
...
- External page and resolver handoffs are treated as short-lived and process-local.
