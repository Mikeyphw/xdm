...
// The runtime lock/licenses and native binaries are generated by the pinned installer.
// Ensure asset/JNI merge tasks cannot observe the source directories before those files
// exist, even when Gradle runs with --parallel.
tasks.matching { task ->
