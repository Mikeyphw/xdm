...
require(phase.get('room_schema_current', 0) >= 17 and project.get('database',{}).get('version', 0) >= 18, 'manifest must report current Room schema 21 or newer while retaining Phase 10 schema provenance')
