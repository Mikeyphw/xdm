...
if current_overlay != expected_overlay and not current_overlay.startswith(("xdm_android_browser_removal_phase8c_", "xdm_android_browser_removal_phase8d_", "xdm_android_browser_removal_phase8e_")):
