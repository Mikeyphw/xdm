...
need(has(application, "NativeHlsMediaManager(", "val recovery = transferRuntime.recoverForStartup()", "val nativeHlsRecovery = runCatching { nativeHlsMediaManager.recoverInterruptedJobs() }", "val nativeHlsMediaManager: NativeHlsMediaManager"), "application startup does not order native HLS recovery after canonical publication-journal reconciliation")
