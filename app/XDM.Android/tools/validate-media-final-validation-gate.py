...
require(re.search(r"version\s*=\s*24\b", database) is not None, "media final gate must track current Room schema 24")
...
require("schemaVersion != 24" in release_models, "final public release gate must track Room schema 24")
