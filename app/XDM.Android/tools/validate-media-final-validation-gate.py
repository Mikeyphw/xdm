...
require(re.search(r"version\s*=\s*25\b", database) is not None, "media final gate must track current Room schema 25")
require(media_gate.get("schema_version_current") in {23, 25}, "PROJECT_MANIFEST media gate must be current-schema aware")
...
require("schemaVersion != 25" in release_models, "final public release gate must track Room schema 25")
