...
need(database,'version = 22','Room schema 22')
...
if entry.get('room_schema_current') != 22: errors.append('manifest schema must be 22')
if manifest.get('database',{}).get('version') != 22: errors.append('authoritative database schema must be 22')
