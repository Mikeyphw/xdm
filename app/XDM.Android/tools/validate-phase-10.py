...
if manifest['database']['version'] != 10: errors.append('project manifest does not declare database v10')
...
if match is None or int(match.group(1)) != 10: errors.append('Room database is not v10')
