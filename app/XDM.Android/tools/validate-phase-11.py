...
if manifest['database']['version'] < 11: errors.append('project manifest database regressed below v11')
...
if match is None or int(match.group(1)) < 11: errors.append('Room database regressed below v11')
...
if errors:
    ...
    sys.exit(1)
print('Phase 11 validation passed: media resolution, variant persistence, selected variant UI, schema v11 or newer, and topography constraints are present')
