...
require(manifest.get("current_overlay") == "xdm_android_phase45_browser_visual_polish_adaptive_layout_overlay.zip", "current_overlay must point at Phase 45 overlay")
