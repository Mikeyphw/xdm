...
require(manifest.get("current_overlay") == "xdm_android_phase46_browser_private_mode_data_isolation_overlay.zip", "current_overlay must point at Phase 46 overlay")
