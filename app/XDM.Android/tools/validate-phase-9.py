...
if manifest['database']['version'] != 9: errors.append('project manifest does not declare database v9')
...
if match is None or int(match.group(1)) != 9: errors.append('Room database is not v9')
