...
try:
    ...
    require(manifest.get('next_phase') in {'media_parity04_browser_ux_userscripts_feedback_final_release_seal', 'field_bugfix_phase_56_stale_copy_architecture_noise_sweep', 'field_bugfix_phase_57_release_prep_or_complete', 'field_bugfix_phase_58_targeted_follow_up_or_complete', 'field_bugfix_phase_59_targeted_follow_up_or_complete', 'field_bugfix_phase_60_targeted_follow_up_or_complete', 'field_bugfix_phase_61_targeted_follow_up_or_complete', 'phase63_release_readiness_support_bundle_seal', 'complete', 'phase64_final_android_downloader_rc_seal', 'phase11_validation_matrix', None}, 'next phase must point to Phase56 stale copy sweep or later release prep')
