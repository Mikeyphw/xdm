...
require('xdm_android_phase56_stale_copy_architecture_noise_sweep_overlay.zip' in phase55_validator and 'xdm_android_phase57_runtime_failure_recovery_ux_overlay.zip' in phase55_validator and 'xdm_android_phase57_runtime_failure_recovery_ux_r2_overlay.zip' in phase55_validator, 'Phase55 validator must tolerate Phase56/Phase57 overlays')
...
try:
    ...
    require(manifest.get('current_overlay') in {'xdm_android_phase56_stale_copy_architecture_noise_sweep_overlay.zip', 'xdm_android_phase57_runtime_failure_recovery_ux_overlay.zip', 'xdm_android_phase57_runtime_failure_recovery_ux_r2_overlay.zip'}, 'current overlay must point to Phase56')
    require(manifest.get('next_phase') in {'field_bugfix_phase_57_release_prep_or_complete', 'field_bugfix_phase_58_targeted_follow_up_or_complete'}, 'next phase must point to release prep / complete')
