...
try:
    ...
    require(manifest.get('next_phase') in {'field_bugfix_phase_58_targeted_follow_up_or_complete', 'field_bugfix_phase_59_targeted_follow_up_or_complete', 'field_bugfix_phase_60_targeted_follow_up_or_complete', 'field_bugfix_phase_61_targeted_follow_up_or_complete', 'phase63_release_readiness_support_bundle_seal', 'complete', 'phase64_final_android_downloader_rc_seal', 'phase11_validation_matrix'}, 'next phase must point to targeted follow-up or complete')
