...
require(manifest.get('next_phase') in {'media_parity04_browser_ux_userscripts_feedback_final_release_seal', 'complete', 'phase63_release_readiness_support_bundle_seal', 'phase64_final_android_downloader_rc_seal', 'phase11_validation_matrix'}, 'next phase should mark completion or point to Phase63 release readiness/support bundle seal')
