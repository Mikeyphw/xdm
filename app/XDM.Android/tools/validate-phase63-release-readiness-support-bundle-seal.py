...
require(manifest.get('next_phase') in {'phase64_final_android_downloader_rc_seal', 'complete', 'phase11_validation_matrix', 'media_parity04_browser_ux_userscripts_feedback_final_release_seal', 'XAR17_313_root_closure_audit_final_gate', 'xar17_313_root_closure_audit_final_gate', None}, 'next phase should point to Phase64, complete, or the accepted XAR17 final-closure gate after final RC seal')
