...
require(manifest.get('next_phase') in {'phase64_final_android_downloader_rc_seal', 'complete', 'phase11_validation_matrix', 'media_parity04_browser_ux_userscripts_feedback_final_release_seal'}, 'next phase should point to Phase64 or complete after final RC seal')
