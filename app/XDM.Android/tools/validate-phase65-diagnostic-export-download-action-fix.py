...
debug_screen = read('app/XDM.Android/app/src/main/kotlin/com/mikeyphw/xdm/android/ui/debug/DebugCenterScreen.kt')
...
has(debug_screen, 'shareTextReport(context, "XDM support report", state.supportReportText)', 'Diagnostics support export action missing')
has(settings, '"Diagnostics & support"', 'Settings diagnostics entry missing')
has(settings, 'SettingsPanel.DebugWorkbench', 'Settings diagnostics route missing')
has(settings, '"Developer Center"', 'Settings Developer Center entry missing')
