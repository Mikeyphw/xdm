...
need("## XDM Android 0.21.0" in readme and ("Room is schema v23" in readme or "Room is schema v24" in readme),
     "README must expose current 0.21.0 / Room v23+ release truth")
