...
if manifest.get("current_uix_overlay") != "xdm_android_uix_r4_media_library_consumer_workflow_overlay.zip":
    ERRORS.append("current_uix_overlay must identify UIX R4")
