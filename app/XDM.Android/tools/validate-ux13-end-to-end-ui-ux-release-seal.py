...
require(manifest.get("current_overlay") in {OVERLAY, POST_UX13_HOTFIX, PARITY01_OVERLAY}, "PROJECT_MANIFEST current_overlay must point to UX13 or its accepted post-release hotfix")
