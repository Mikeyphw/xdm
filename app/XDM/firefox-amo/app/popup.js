...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  document.getElementById("extensionId").textContent = status.extensionId || browser.runtime.id;
...
function send(message) {
  return browser.runtime.sendMessage(message).catch(error => ({ ok: false, reason: error.message }));
}
