...
type Lifecycle = transferlifecycle.Lifecycle

// SQLiteLifecycle remains exported here as a compatibility alias while the
// authoritative implementation is protocol-neutral for HTTP, FTP and future backends.
type SQLiteLifecycle = transferlifecycle.SQLiteLifecycle
